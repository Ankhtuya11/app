      ...
      <ScrollView>
        ...
        <View id="field" style={styles.field}>
          <View style={styles.vm1_2}>
            ...
            <View>
              <Text style={styles.name}>
                Gatsuurhan
                <Entypo name="emoji-sad" style={styles.emoji} />
              </Text>
          ...
          <View style={styles.vm2_2}>
            <Text style={styles.txt2_2}>Зорилго</Text>
          </View>

          <View>
            <Text style={styles.setgegdel}>
              Lorem Ipsum is simply dummy text of the printing and typesettina
              to make a type five centuries, but also the leap into electronic
              typesetting, remaining essentially uncha
            </Text>
        ...
        <View id="field" style={styles.field}>
          ...
          <View style={styles.vm2_2}>
            <Text style={styles.txt2_2}>Стресс</Text>
          </View>
        ...
        <View id="field" style={styles.field}>
          <View style={styles.vm1_2}>
            ...
            <View>
              <Text style={styles.name}>
                Gatsuurhan <Entypo name="emoji-sad" style={styles.emoji} />
              </Text>
              <Text id="ner" style={styles.name2}>
                11min
              </Text>
